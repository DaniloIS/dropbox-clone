class DropBoxController {
    ...
    connectFirebase() {
        ...
        const firebaseConfig = {
          apiKey: "AIzaSyAUCa2q8rRxp7zm6fdmCg2QBiDyPpsvIhs",
          authDomain: "dropbox-clone-5446d.firebaseapp.com",
          databaseURL: "https://dropbox-clone-5446d-default-rtdb.firebaseio.com",
          projectId: "dropbox-clone-5446d",
          storageBucket: "dropbox-clone-5446d.appspot.com",
          messagingSenderId: "793501505098",
          appId: "1:793501505098:web:ca4d05f19ab54c44e7f8b3",
          measurementId: "G-G7ZQ6Y67T1"
        };
    ...
    initEvents() {
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.btnSendFileEl.desabled  = true;
    ...
    uploadComplete() {
        ...
        this.btnSendFileEl.desabled  = false;
    ...
    uploadTask(files) {
        ...
        [...files].forEach(file => {
            ...
            promises.push(new Promise((resolve, reject) => {
                ...
                ajax('/upload', 'POST', formData, onprogress = function(){}, onloadstart = function(){})
